...
} from "foundry-chainlink-toolkit/lib/chainlink-brownie-contracts/contracts/src/v0.8/interfaces/AggregatorV3Interface.sol";

/// @title RWA_CarNFT - NFT representation of real-world cars with depreciation and Chainlink price feeds
...
contract RWA_CarNFT is ERC721, ERC721URIStorage, AccessControl, ERC721Pausable {
    ...
    event CarUnlocked(uint256 indexed tokenId, address indexed owner);
    ...
    modifier onlyAutomation() {
        require(msg.sender == automation, "Not authorized");
        _;
    }
    ...
    function executePostUnlock(
        ...
        emit CarUnlocked(tokenId, owner);
    }
    ...
    function mintCarNFT(
        ...
        cars[tokenId] = Car({
            ...
            purchaseYear: block.timestamp / 365 days,
            forSale: false,
            priceUSD: 0
        });
    ...
    function getConversionRate(
        ...
        uint256 ethAmount = (usdAmount * 1e18 * 10 ** decimals) /
            ethUsdPriceUint;
        return ethAmount;
    }
